"""
Django settings for magf_41437 project.
...
WSGI_APPLICATION = 'magf_41437.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "magf_41437 API",
    "DESCRIPTION": "API documentation for magf_41437 App",
    "VERSION": "v1",
}
